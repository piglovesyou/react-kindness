    ...
    return (
      <React.Fragment>
        ...
        <header className="page-header" role="banner">
          ...
          <Kindness order={10} message="To stop this, click here.">
            <button
              type="button"
              className="btn"
        ...
        <main id="content" className="main-content" role="main">
          <p>
            Text can be
            <strong>bold</strong>,<em>italic</em>, or
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style={{ textAlign: 'left' }}>
                  good
                  <code className="highlighter-rouge">oreos</code>
                </td>
              ...
              <tr>
                ...
                <td style={{ textAlign: 'left' }}>
                  good
                  <code className="highlighter-rouge">zoute</code> drop
                </td>
          ...
          <p>
            ...
            >
              <img
                src="https://assets-cdn.github.com/images/icons/emoji/octocat.png"
                alt="Octocat"
              />
            </Kindness>
          </p>
